...
const dateInputStyle =
  "relative inline-flex h-9 w-full items-center overflow-hidden whitespace-nowrap cursor-pointer rounded-md border bg-background border-input px-3 py-2 text-sm shadow-xs transition-[color,box-shadow] outline-none data-focus-within:border-ring data-focus-within:ring-ring/50 data-focus-within:ring-[3px] data-focus-within:aria-invalid:ring-destructive/20 dark:data-focus-within:aria-invalid:ring-destructive/40 data-focus-within:aria-invalid:border-destructive aria-invalid:border-destructive"
