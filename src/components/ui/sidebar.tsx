	...
	return (
		<main
			...
			className={cn(
				...
				"min-[56rem]:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 max-h-dvh",
				"min-[56rem]:max-h-[calc(100dvh-1rem)] overflow-hidden min-[56rem]:peer-data-[variant=inset]:m-2",
				"min-[56rem]:peer-data-[variant=inset]:ml-0 min-[56rem]:peer-data-[variant=inset]:rounded-xl",
				"min-[56rem]:peer-data-[variant=inset]:shadow-sm",
				className,
			)}
			{...props}
		/>
