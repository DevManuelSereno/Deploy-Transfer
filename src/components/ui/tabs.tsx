...
function TabsList({
	...
	return (
		<MotionHighlight
			controlledItems
			className={cn("rounded-sm bg-transparent", activeClassName)}
			value={activeValue}
			transition={transition}
		>
			<div
		...
		<MotionHighlightItem value={value} className="size-full">
			<motion.button
				...
				className={cn(
					...
					"focus-visible:outline-ring dark:data-[state=active]:border-input text-foreground",
					"dark:text-muted-foreground inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center",
