...
export const Icons = {
	spinner: ({ className }: LucideProps) => {
		const bars = Array(12).fill(0);

		return (
			<div className={cn("size-[16px]")}>
				<div
				...
				>
					{bars.map((_, i) => (
						<div
							...
							className={cn(
								"absolute top-[-3.9%] left-[-10%] h-[1.4px] w-[4px] shrink-0 animate-spinner rounded-md bg-current",
								`bar:nth-child(${i + 1})`,
								className,
							)}
							style={{
	...
	openAIblack: ({ className, ...props }: LucideProps) => (
		<svg
			width="40"
			height="40"
			viewBox="0 0 721 721"
	...
	exclamationCircle: ({ className, ...props }: LucideProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="24"
			height="24"
