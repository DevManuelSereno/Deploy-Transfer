...
import { useOccurrenceFormOptions } from "@/app/[locale]/vehicle/hooks/use-occurrence-form-options";
...
import type {
	...
	OccurrenceForm,
	OccurrencePayload,
} from "@/app/[locale]/vehicle/types/types-occurrence";
import type { ImageValue } from "@/app/[locale]/vehicle/types/types-vehicle";
import {
	OccurrenceFormSchema,
	OccurrencePayloadSchema,
} from "@/app/[locale]/vehicle/validation/validation-occurrence";
