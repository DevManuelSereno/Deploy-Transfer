...
export function ModalTableOccurrence({ open, setOpen, children }: ModalFormProps) {
	const t = useTranslations("OccurrencePage.Modal");
			...
			>
				<div className="flex items-center gap-3 px-6 pt-6 mb-4">
					<div className="flex size-11 shrink-0 items-center justify-center rounded-full border">
						<Fuel size={16} className="opacity-80" />
					</div>
